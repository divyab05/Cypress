...
describe('Test Suite :: Support Console tests', () => {
  ...
  it(`<@supportconsole>TC001 - Client Setup - Search and Verify Cost Acocunts`, function () {
    ...
    supportConsoleCommands.selectSubtabUnderClientSetup(SupportConsoleCommands.COSTACCOUNTS);
    supportConsoleCommands.searchCostAccountsExist('Automation Cost Account');
  });
