...
describe('Test Suite :: Support Console tests', () => {
  ...
  it(`<@supportconsole>TC001 - Client Setup - Search and Verify Carrier Acocunts`, function () {
    ...
    supportConsoleCommands.selectSubtabUnderClientSetup(SupportConsoleCommands.CARRIERACCOUNTS);
    supportConsoleCommands.searchCarrierAccountsExist('USPS');
  });
