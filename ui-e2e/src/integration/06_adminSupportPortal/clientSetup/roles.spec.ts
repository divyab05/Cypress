...
describe('Test Suite :: Support Console tests', () => {
  ...
  it(`<@supportconsole>TC001 - Client Setup - Search and Verify Roles`, function () {
    ...
    supportConsoleCommands.selectSubtabUnderClientSetup(SupportConsoleCommands.ROLES);
    supportConsoleCommands.searchRolesExist('ADMIN');
  });
