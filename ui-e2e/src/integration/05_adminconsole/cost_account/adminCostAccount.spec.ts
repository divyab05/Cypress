...
describe('Test Suite :: Cost Accounts', () => {
  ...
  it(`<@promote_qa @platform_e2e><@platform_ppd>TC001 - Add Cost Account, Search by Name or Code and delete`, function () {
  ...
  it(`<@platform_e2e><@platform_ppd>TC002 - Add Division Cost Account, Search by Name or Code and delete`, function () {
    const uuidGenerator = () => Cypress._.random(0, 1e5);
    const uniqueNum = `${uuidGenerator()}`;
  ...
  it(`<@platform_e2e><@platform_ppd>TC003 - Add Location Cost Account, Search by Name or Code and delete`, function () {
    const uuidGenerator = () => Cypress._.random(0, 1e5);
    const uniqueNum = `${uuidGenerator()}`;
  ...
  it(`<@promote_qa @platform_e2e><@platform_ppd>TC004 - Add Sub Cost Account and delete`, function () {
    const uuidGenerator = () => Cypress._.random(0, 1e5);
    const uniqueNum = `${uuidGenerator()}`;
  ...
  it(`<@platform_e2e><@platform_ppd>TC005 - Create Active Cost account, change to Inactive and validate in the UI`, function () {
    const uuidGenerator = () => Cypress._.random(0, 1e5);
    const uniqueNum = `${uuidGenerator()}`;
  ...
  it(`<@platform_e2e><@platform_ppd>TC007 - Add Division Cost Account and change the Access level to Location level, Validated the entity level in the Grid`, function () {
    const uuidGenerator = () => Cypress._.random(0, 1e5);
    const uniqueNum = `${uuidGenerator()}`;
    const newDivCostAccount = {
      name: 'CADiv' + uniqueNum,
  ...
  it(`<@platform_e2e><@platform_ppd>TC008 - Add Location Cost Account and change the Access level to Division level, Validated the entity level in the Grid`, function () {
    const uuidGenerator = () => Cypress._.random(0, 1e5);
    const uniqueNum = `${uuidGenerator()}`;
    const newLocCostAccount = {
      name: 'CALoc' + uniqueNum,
  ...
  if (Cypress.env('appEnv').includes('fed') === false) {
    it(`<@platform_e2e>TC006 - Enterprise level inactive cost account should not display for Division and Location level client`, function () {
      const uuidGenerator = () => Cypress._.random(0, 1e5);
      const uniqueNum = `${uuidGenerator()}`;
      const activeToInactiveCostAccount = {
        name: 'Auto_activeToInactiveCA' + uniqueNum,
  ...
  it(`<@platform_e2e><@platform_ppd>TC010 - Verify Cost Account should not be created with duplicate account id, Code`, function () {
    const uuidGenerator = () => Cypress._.random(0, 1e5);
    const uniqueNum = `${uuidGenerator()}`;
  ...
  it.skip(`<@platform_e2e><@platform_ppd>TC011 - Sorting in Cost Account Grid`, function () {
  ...
  it(`<@platform_e2e>TC012 - Add Cost Account with Billable and Password Enabled`, function () {
    const uuidGenerator = () => Cypress._.random(0, 1e5);
    const uniqueNum = `${uuidGenerator()}`;
    const parentCostAccount = {
  ...
  it.skip(`<@platform_e2e>TC013 - Edit Sub Cost Account Description and change the access level from enterprise to Division`, function () {
    const uuidGenerator = () => Cypress._.random(0, 1e5);
    const uniqueNum = `${uuidGenerator()}`;
    const parentCostAccount = {
